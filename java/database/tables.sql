...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protein, is_low_carb, is_low_sodium, is_breakfast, is_lunch, is_dinner, img) 
	VALUES ('Lighter chicken cacciatore', '1 tbsp olive oil, 3 slices prosciutto, 1 medium onion, 2 garlic cloves, 2 sage sprigs, 2 rosemary sprigs, 4 skinless chicken breasts , 150ml dry white wine, 400g can plum tomatoes, 225g chestnut mushrooms', 760, false, true, true, false, false, true, true, 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/lighter-chicken-cacciatore-c94e376.jpg?quality=90&webp=true&resize=300,272');
