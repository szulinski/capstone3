...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
	VALUES ('Peanut Butter and Jelly',
			...
			350, false, true, false, false, 'https://www.google.com/search?q=pbj&sxsrf=APq-WBsT699K3YwUuYZ0-CCMcMPBiA5NJQ:1649785343716&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjirPiqiY_3AhUBd98KHfEHAZQQ_AUoAXoECAIQAw&biw=1920&bih=969&dpr=1#imgrc=rMc2T4GBSUhTQM');
...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
	VALUES ('Sunny-Side up Eggs',
		   ...
		   150, true, true, true, true, 'https://www.google.com/search?q=fried+egg&sxsrf=APq-WBvb-T0DF3vPTKjItEs3ibyh-eqTAw:1649786310849&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjstY34jI_3AhUhmeAKHTJdCSkQ_AUoAXoECAEQAw&biw=1920&bih=912&dpr=1#imgrc=I-XKtUiQ5vxGPM');
...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
	VALUES ('Roasted Chicken And Vegetables',
		   ...
		   '1, line your baking sheet with aluminum foil or parchment paper. 2, Chop up all of your veggies and arrange them in a single layer on your pan. Drizzle with oil and season with salt and pepper. Then, use a mixing spatula or large spoon to toss the veggies so they are evenly coated. 3, Toss the chicken breasts with oil and spices, then lay them on top of the veggies. Be sure there is plenty of space between each one. As a result, they will all cook evenly. 4, Bake for 20-25 minutes, or until chicken is cooked through. If you’re meal prepping, divide the chicken and vegetables into equal amounts and place into individual containers.',
			500, true, true, true, true, 'https://www.primaverakitchen.com/wp-content/uploads/2020/02/Mediterranean-Roasted-Chicken-Breast-Primavera-Kitchen-3-800x1200.jpg' );
...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
	VALUES ('French Onion Soup',
			...
			360, false, false, false, false, 'https://www.mustlovehome.com/wp-content/uploads/2019/10/Classic-French-Onion-Soup-4-600x900.jpg');
...
INSERT INTO recipes (recipe_name, ingredients, directions, calories, is_low_fat, is_high_protien, is_low_carb, is_low_sodium, img) 
	VALUES ('Overnight Oats',
			...
			240, true, true, false, true, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-p_0xkiye_670anaFW_mZFf-XkbjddPl2-g&usqp=CAU');
